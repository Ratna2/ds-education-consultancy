    ...
    <main className="bg-white text-slate-900">
      ...
      <section className="relative w-screen h-[90vh] overflow-hidden left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] text-white">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="px-8 py-3 rounded-full bg-blue-600 hover:bg-blue-700 transition duration-300 font-semibold shadow-lg">
      ...
      <section className="bg-blue-50 py-12">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 text-center gap-10">
          ...
          <div>
            <h3 className="text-3xl font-bold text-blue-600">₹20–35L</h3>
            <p className="mt-2 text-sm text-slate-600">
              Total Course Fees
            </p>
          </div>
          ...
          <div>
            <h3 className="text-3xl font-bold text-blue-600">6 Years</h3>
            <p className="mt-2 text-sm text-slate-600">
              Course Duration
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
            ...
            <div>
                ...
                <li className="flex gap-3">
                    ...
                    <span>
                    <strong>Globally Recognized Degrees:</strong> Russian medical
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-blue-100 hover:shadow-xl transition duration-300">

                <img
                src="/images/russia-life.jpg"
                alt="Life in Russia"
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                    Russia offers a vibrant multicultural environment with a large Indian
      ...
      <section className="py-20 bg-white overflow-hidden">
        <div className="container-custom">
            ...
            <p className="text-slate-500 mt-3 text-sm">
                Russian medical universities have been training international students for over 50 years
            </p>
      ...
      <section className="py-20 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto px-6">
            ...
            {/* Main Box */}
            <div className="bg-white shadow-2xl rounded-2xl p-8 md:p-12 grid md:grid-cols-2 gap-12 border border-blue-100">
            ...
            <div className="bg-white rounded-xl p-8 shadow-md border border-blue-100">
                ...
                <div className="flex items-start gap-4">
                    <div className="w-9 h-9 flex items-center justify-center bg-blue-600 text-white rounded-full text-sm font-bold shadow-md">
                    1
                    </div>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <p className="text-sm text-slate-700 leading-relaxed">
                    <span className="font-bold">September – October:</span> Travel to Russia and begin classes
                    </p>
                </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container-custom">
            ...
            <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition duration-500 transform hover:-translate-y-3 hover:scale-105 border border-gray-200">
                <div className="bg-gradient-to-r from-red-600 to-blue-500 text-white p-5 rounded-t-2xl">
                ...
                <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-blue-600">₹3.5 – ₹6.5 Lakhs</span>
                </div>
                <div className="flex justify-between">
                    <span>2nd–6th Year (per year)</span>
                    <span className="font-semibold text-blue-600">₹2.5 – ₹4.5 Lakhs</span>
                </div>
                <div className="flex justify-between border-t pt-4">
                    <span className="font-medium">Total Course Fee</span>
                    <span className="font-bold text-blue-700 text-lg">₹15 – ₹25 Lakhs</span>
                </div>
            ...
            {/* Hostel & Living Card */}
            <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition duration-500 transform hover:-translate-y-3 hover:scale-105 border border-gray-200">
                <div className="bg-gradient-to-r from-blue-600 to-blue-500 text-white p-5 rounded-t-2xl">
                ...
                <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-blue-600">₹50,000 – ₹1.2L</span>
                </div>
                <div className="flex justify-between">
                    <span>Food (per month)</span>
                    <span className="font-semibold text-blue-600">₹15,000 – ₹20,000</span>
                </div>
                <div className="flex justify-between">
                    <span>Miscellaneous</span>
                    <span className="font-semibold text-blue-600">₹10,000/month</span>
                </div>
                <p className="text-sm text-gray-500 italic">
            ...
            <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition duration-500 transform hover:-translate-y-3 hover:scale-105 border border-gray-200">
                ...
                <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-blue-600">₹10,000 – ₹15,000</span>
                </div>
                <div className="flex justify-between">
                    <span>Visa Extension</span>
                    <span className="font-semibold text-blue-600">₹5,000 – ₹8,000</span>
                </div>
                <div className="flex justify-between">
                    <span>Airfare (Round Trip)</span>
                    <span className="font-semibold text-blue-600">₹25,000 – ₹40,000</span>
                </div>
                <p className="text-sm text-gray-500 italic">
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-50">
        <div className="container-custom">
            ...
            {/* Header Row */}
            <div className="bg-gradient-to-r from-blue-600 to-red-500 text-white grid grid-cols-5 px-6 py-4 font-semibold text-sm md:text-base">
                <div>University</div>
            ...
            <div className="divide-y">
                ...
                {/* Row 1 */}
                <div className="grid grid-cols-5 px-6 py-5 items-center hover:bg-red-50 transition duration-300">
                <div className="font-medium">Crimea Federal University</div>
                <div>₹3.8 Lakhs</div>
                <div>₹60,000</div>
                <div className="font-bold text-blue-600">₹22 Lakhs</div>
                <div className="text-green-600 text-xl">✔</div>
                </div>

                {/* Row 2 */}
                <div className="grid grid-cols-5 px-6 py-5 items-center hover:bg-blue-50 transition duration-300">
                <div className="font-medium">Kazan Federal University</div>
                <div>₹4.2 Lakhs</div>
                <div>₹75,000</div>
                <div className="font-bold text-blue-600">₹25 Lakhs</div>
                <div className="text-green-600 text-xl">✔</div>
                </div>
                ...
                <div>₹3.2 Lakhs</div>
                <div>₹50,000</div>
                <div className="font-bold text-blue-600">₹19 Lakhs</div>
                <div className="text-green-600 text-xl">✔</div>
                </div>
                ...
                <div>₹3.5 Lakhs</div>
                <div>₹55,000</div>
                <div className="font-bold text-blue-600">₹20.5 Lakhs</div>
                <div className="text-green-600 text-xl">✔</div>
                </div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="container-custom">
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition duration-300 border border-gray-100 hover:-translate-y-2">
                ...
                <div className="w-14 h-14 flex items-center justify-center rounded-full bg-blue-100 text-blue-600 text-2xl mb-6 group-hover:bg-blue-600 group-hover:text-white transition duration-300">
                🎓
                </div>
                ...
                Russian government offers <span className="font-semibold text-blue-600">15% – 100% tuition fee waiver</span> 
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition duration-300 border border-gray-100 hover:-translate-y-2">
                ...
                <p className="text-gray-600 leading-relaxed">
                Many universities provide <span className="font-semibold text-blue-600">10% – 50% discount</span> 
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition duration-300 border border-gray-100 hover:-translate-y-2">
                ...
                <p className="text-gray-600 leading-relaxed">
                Get <span className="font-semibold text-blue-600">5% – 10% discount</span> 
      ...
      <section className="py-24 bg-gradient-to-b from-white via-blue-50 to-white">
        <div className="container-custom">
            ...
            {/* Practice in India */}
            <div className="group bg-white/70 backdrop-blur-lg border border-blue-100 rounded-3xl p-10 shadow-xl hover:shadow-2xl transition duration-500 hover:-translate-y-3">

                <div className="w-16 h-16 flex items-center justify-center rounded-full bg-blue-100 text-blue-600 text-3xl mb-6 group-hover:bg-blue-600 group-hover:text-white transition duration-300">
                🇮🇳
                </div>
                ...
                <p className="text-gray-600 leading-relaxed">
                Clear the <span className="font-semibold text-blue-600">FMGE/NExT exam</span>, 
            ...
            <div className="group bg-white/70 backdrop-blur-lg border border-blue-100 rounded-3xl p-10 shadow-xl hover:shadow-2xl transition duration-500 hover:-translate-y-3">
                ...
                <span className="font-semibold text-blue-600"> PLAB (UK), USMLE (USA), AMC (Australia)</span> 
            ...
            <div className="group bg-white/70 backdrop-blur-lg border border-blue-100 rounded-3xl p-10 shadow-xl hover:shadow-2xl transition duration-500 hover:-translate-y-3">
                ...
                <p className="text-gray-600 leading-relaxed">
                Pursue <span className="font-semibold text-blue-600">MD/MS</span> in Russia, India, 
      ...
      <section className="relative py-20 bg-gradient-to-br from-blue-600 via-red-700 to-blue-800 text-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-xl hover:scale-105 transition">
                ...
                <p className="mt-2 text-blue-100">Visa Success Rate</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-xl hover:scale-105 transition">
                ...
                <p className="mt-2 text-blue-100">Partner Institutions</p>
            </div>
...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="mb-6 border border-blue-100 rounded-2xl bg-white/80 backdrop-blur-lg shadow-md transition duration-300 hover:shadow-lg">
