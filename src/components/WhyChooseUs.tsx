    ...
    <section className="py-24 bg-white overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold mt-6 text-slate-900">
            Trust{" "}
        ...
        <div className="grid md:grid-cols-3 gap-10 mb-32">
          {[
            ...
            <div
              key={i}
              className="relative rounded-2xl p-10 text-white shadow-xl 
              bg-gradient-to-br from-blue-600 to-indigo-700 
              hover:shadow-2xl hover:-translate-y-2 transition-all duration-300"
            >
              <div className="w-16 h-16 flex items-center justify-center 
              bg-white/20 backdrop-blur-md rounded-full mb-8">
                {item.icon}
              </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
          ...
          >
            ...
            <button
              ...
              className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-3 rounded-xl font-semibold shadow hover:opacity-90 transition"
            >
              Learn More
            </button>
          </div>
        ...
        {/* ================= NEW SECTION 2 (SLIDE FROM RIGHT) ================= */}
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <button
              onClick={() => router.push("/about")}
              className="bg-blue-600 text-white px-8 py-3 rounded-xl font-semibold shadow hover:bg-blue-700 transition"
            >
              Explore More
            </button>
          </div>
          ...
          {/* IMAGE RIGHT */}
          <div
            className={`transition-all duration-3000 delay-200 ${
              visible ? "translate-x-0 opacity-100" : "translate-x-24 opacity-0"
            }`}
          >
            <img
